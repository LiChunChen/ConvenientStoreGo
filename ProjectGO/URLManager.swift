...
//let testRequestURL = "https://convenientgo.000webhostapp.com/AllPHP.php"
...
//typealias testDoneHandler = (Bool,Error?,[Any]?) -> Void
...
class URLManager {
    ...
    /*
    func testForRequest(parameters: [String:Any], urlString: String ,doneHandler:@escaping DoneHandler) {
...
//                if parameters["DB"] as! String == "EnglishDB" {
                print(results)
                    var item = Item()
                    var items = [Item]()
                for i in results {
